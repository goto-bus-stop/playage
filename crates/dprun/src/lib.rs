...
const GUID_DPRUNSP: GUID = GUID(
    0xb1ed_2367, 0x609b, 0x4c5c, 0x87, 0x55, 0xd2, 0xa2, 0x9b, 0xb9, 0xa5, 0x54,
);
/// The GUID of the DirectPlay address type containing a port number.
const GUID_INETPORT: GUID = GUID(
    0xe452_4541, 0x8ea5, 0x11d1, 0x8a, 0x96, 0x00, 0x60, 0x97, 0xb0, 0x14, 0x11,
);
...
mod tests {
    ...
    fn build_command_line_args() {
        let dpchat = GUID(
            0x5BFDB060, 0x06A4, 0x11D0, 0x9C, 0x4F, 0x00, 0xA0, 0xC9, 0x05, 0x42, 0x5E,
        );
        let tcpip = GUID(
            0x36E95EE0, 0x8577, 0x11cf, 0x96, 0x0c, 0x00, 0x80, 0xc7, 0x53, 0x4e, 0x82,
        );
        let inet_port = GUID(
            0xe4524541, 0x8ea5, 0x11d1, 0x8a, 0x96, 0x00, 0x60, 0x97, 0xb0, 0x14, 0x11,
        );
